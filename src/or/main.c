...
do_main_loop(void)
{
  ...
  printf("Initialize relay-side HS circuitmap\n");
...
{
  int result = 0;
  printf("Custom built Tor by Nick Frichette!\n");
  ...
  //This will activate some logic for error handling and backtrace
  ...
  printf("Completed the tor init process\n");
